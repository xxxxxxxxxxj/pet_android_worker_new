...
public abstract class NormalDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDrawOver(Canvas canvas, RecyclerView recyclerView, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (pos == 0 || !curHeaderName.equals(getHeaderName(pos - 1))) {//如果当前位置为0，或者与上一个item头部名不同的，都腾出头部空间
                ...
                if (headerDrawEvent != null) {
                    ...
                    canvas.drawRect(left, viewTop - headerHeight, right - mContext.getResources().getDimensionPixelSize(R.dimen.dp_30), viewTop, mHeaderContentPaint);
        ...
        if (headerDrawEvent != null) {//inflater
            ...
            /*绘制悬浮的头部*/
            canvas.drawRect(left, 0, right - mContext.getResources().getDimensionPixelSize(R.dimen.dp_30), headerHeight, mHeaderContentPaint);
