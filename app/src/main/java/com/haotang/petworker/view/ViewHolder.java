...
public class ViewHolder {
	 ...
	 * @return
	 */
	public ViewHolder setTextColor(int viewId, String text) {
		TextView view = getView(viewId);
	 ...
	 * @return
	 */
	public ViewHolder setBackgroundDrawable(int viewId, String text) {
		TextView view = getView(viewId);
		view.setBackgroundDrawable(Utils.getDW(text));
		return this;
	}
	...
	public ViewHolder setBackgroundCircle(int viewId, String imageurl,
		...
		Utils.setImageWithTag(view, imageurl, R.drawable.user_icon_unnet);
		return this;
	}
