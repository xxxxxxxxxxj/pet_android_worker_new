...
public class JsonHttpResponseHandler extends TextHttpResponseHandler {
	...
	/**
	 * Creates new JsonHttpResponseHandler with JSON String encoding UTF-8 and
	 * given RFC5179CompatibilityMode
	 * 
	 * @param useRFC5179CompatibilityMode
	 *            Boolean mode to use RFC5179 or latest
	 */
	...
	/**
	 * Creates new JsonHttpResponseHandler with given JSON String encoding and
	 * RFC5179CompatibilityMode
	 * 
	 * @param encoding
	 *            String encoding to be used when parsing JSON
	 * @param useRFC5179CompatibilityMode
						...
						postRunnable(new Runnable() {
							...
							public void run() {
								...
								if (!useRFC5179CompatibilityMode
									...
									// In RFC5179 a simple string value is not a
									// valid JSON
									if (useRFC5179CompatibilityMode) {
										onFailure(
												statusCode,
	...
	protected Object parseResponse(byte[] responseBody) throws JSONException {
		...
		if (jsonString != null) {
			...
			if (useRFC5179CompatibilityMode) {
				...
				// Check if the string is an JSONObject style {} or JSONArray
				// style []
	...
	public void setUseRFC5179CompatibilityMode(
			boolean useRFC5179CompatibilityMode) {
		this.useRFC5179CompatibilityMode = useRFC5179CompatibilityMode;
	}
