 ...
 *******************************************************************************/
package com.haotang.petworker.pulltorefresh.internal;

import com.haotang.petworker.R;
import com.haotang.petworker.pulltorefresh.ILoadingLayout;
import com.haotang.petworker.pulltorefresh.PullToRefreshBase.Mode;
import com.haotang.petworker.pulltorefresh.PullToRefreshBase.Orientation;
...
public abstract class LoadingLayout extends FrameLayout implements
	...
	public LoadingLayout(Context context, final Mode mode,
		...
		WindowManager wndMgr = (WindowManager) context.getApplicationContext()
	...
	public final void showInvisibleViews() {
		if (View.INVISIBLE == mHeaderText.getVisibility()) {
			...
			// Global.getScreenSize(this.getContext().getApplicationContext()).y
			// / 40);
		}
		...
		if (View.INVISIBLE == mSubHeaderText.getVisibility()) {
			mSubHeaderText.setVisibility(View.VISIBLE);
			// mSubHeaderText.setTextSize(TypedValue.COMPLEX_UNIT_PX,
			// Global.getScreenSize(this.getContext().getApplicationContext()).y
			// / 40);
		}
	}
