 ...
 *
 * @author 徐俊
 * @date zhoujunxia on 2018/9/8 17:17
 */
public class ArchivesBeforeImgAdapter extends BaseQuickAdapter<String, BaseViewHolder> {
    ...
    public ArchivesBeforeImgAdapter(int layoutResId, List<String> data) {
