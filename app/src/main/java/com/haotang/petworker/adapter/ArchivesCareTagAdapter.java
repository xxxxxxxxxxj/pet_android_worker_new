 ...
 *
 * @author 徐俊
 * @date zhoujunxia on 2018/9/8 17:01
 */
public class ArchivesCareTagAdapter  extends BaseQuickAdapter<CareTag, BaseViewHolder> {

    public ArchivesCareTagAdapter(int layoutResId, List<CareTag> data) {
