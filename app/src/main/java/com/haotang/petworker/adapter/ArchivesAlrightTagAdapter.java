 ...
 *
 * @author 徐俊
 * @date zhoujunxia on 2018/9/8 16:59
 */
public class ArchivesAlrightTagAdapter extends BaseQuickAdapter<CareTag, BaseViewHolder> {

    public ArchivesAlrightTagAdapter(int layoutResId, List<CareTag> data) {
