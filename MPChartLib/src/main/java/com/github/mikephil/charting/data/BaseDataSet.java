...
import com.github.mikephil.charting.renderer.GradientColors;
...
public abstract class BaseDataSet<T extends Entry> implements IDataSet<T> {
    ...
    private List<GradientColors> gradientColorsList;
    ...
    public List<GradientColors> getGradientColorsList() {
        return gradientColorsList;
    }

    public void setGradientColorsList(List<GradientColors> gradientColorsList) {
        this.gradientColorsList = gradientColorsList;
    }

    @Override
    public List<GradientColors> getGradientColors() {
        return this.gradientColorsList;
    }
